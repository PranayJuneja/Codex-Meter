...
grep -q 'VERSION_NAME = "1.7.0"' "$ROOT/app/src/main/java/dev/bennett/codexmeter/AppConstants.java"
grep -q 'VERSION_CODE = 8' "$ROOT/app/src/main/java/dev/bennett/codexmeter/AppConstants.java"
grep -q 'VERSION_NAME="1.7.0"' "$ROOT/build.sh"
grep -q 'VERSION_CODE="8"' "$ROOT/build.sh"
